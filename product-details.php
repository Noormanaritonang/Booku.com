							...
							<div class="col-sm-9">
								<div class="product-information"><!--/product-information-->
									...
									<span>
										...
										<span><del>Rp.<?php echo $row["Price"];?>,00</del>  Rp.<?php echo $hargaAkhir = $row["Price"] - ($potongan = ($row["Price"]*$row["discount"])/100);?>,00</span>
										<label>Jumlah :</label>
									...
									<br>
									<p>Promo Diskon <b><i><?php echo $row["discount"];?>%</i></b> hingga <b><i><?php echo $row["promodiskon"];?></i></b></p>
									<br>
...
<form id="form1" name="form1" method="post" action="#">
  <table width="400" border="1">
    <tr>
      <td colspan="2"><strong>Tingggalkan Komentar Anda untuk Kemajuan <i>Booku.com</i></strong></td>
    </tr>
    <tr>
